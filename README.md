...
Alternatively, instead of tar, you can use rsync, rsnap or zbackup to perform
the archiving.
...
zbackup is a globally-deduplicating backup tool. Feed a large .tar into it,
...
File::Copy::Recursive is used to copy the MySQL configuration file(s).
